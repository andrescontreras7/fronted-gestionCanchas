...
export function NewUserModal({ isOpen, onClose, roles, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.username || !formData.email || !formData.password || !formData.last_name || !formData.role) {
    ...
    try {
      ...
      onSuccess?.()
      onClose()
      setFormData({ username: "", email: "", password: "", last_name: "", role: "" })
    } catch (error) {
