import { ProtectedButton, ProtectedComponent } from '@/components/ProtectedComponent';
...
const CourtsDetail = ({
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Capacidad: {courtsDetail.capacidad_jugadores} jugadores</span>
              </div>
              
              <div className="flex items-center gap-2">
                <DollarSign className="h-4 w-4 text-muted-foreground" />
                <span className="text-sm">
                  ${courtsDetail.precio_por_hora?.toLocaleString('es-CL')}/hora
                </span>
              </div>
            </div>
      ...
      <ProtectedComponent permissions={[PERMISSIONS.EDITAR_CANCHAS, PERMISSIONS.ELIMINAR_CANCHAS]}>
        <Card>
          <CardHeader>
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              {onToggleDisponibilidad && (
                ...
                >
                  ...
                  {courtsDetail.disponible ? 'Marcar No Disponible' : 'Marcar Disponible'}
                </ProtectedButton>
              )}
